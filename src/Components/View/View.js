...
function View() {
  ...
  return (
    <>
      <div style={{ backgroundColor: "#415A77", padding : "20px", boxShadow : "1px 2px 10px 5px black"}}>
        <h2 style={{fontWeight:"bold"}}>VIEW BOOKINGS</h2>
        <Container className="viewbooking-container" style={{
